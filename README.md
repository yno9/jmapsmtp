...
> (`ADMIN_TOKEN`) will change what your monitoring sees: with it unset, Go
> opens every admin route and this port closes them. SPEC.md §11 lists the
> rest.
...
| [PLAN.md](PLAN.md) | The porting plan (Japanese) |
