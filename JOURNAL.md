...
## 2026-08-05 — M8b（ドキュメントとベンチ）完了 = **M8 完了** (`83d8f21` / `09d9b55` / `f3264e7`)
...
## 2026-08-02 — M8a（difftest が oracle 対 Rust で通った）(`5454acb`)
...
## 2026-08-02 — M7c（Web Push 送信）完了 = **M7 完了** (`de13ea7`)
...
## 2026-08-02 — M7b（identity anchor クライアント）完了 (`506f0b2`)
...
## 2026-08-02 — M7a（受信 STARTTLS）完了 (`2b51178`)
...
## 2026-08-02 — M6z（送信サブミッション）完了 (`db274e3`)
...
## 2026-08-02 — M6y（受信配送・SMTP リスナ・非活動アカウント掃除）完了 (`a018e61`)
...
## 2026-08-02 — M6x（Web Push と event-source）完了 (`fa30892`)
...
## 2026-08-02 — M6w（カスタムドメインと DNS クライアント）完了 (`b89daf1`)
...
## 2026-08-02 — M6v（管理ダッシュボードと Prometheus メトリクス）完了 (`98722e6`)
